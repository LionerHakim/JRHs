...
Applied to JRHs as a quality filter for UI, copy, accessibility, responsive layout, and code comments.

## Usage mode
DURING: apply these rules while building or modifying the project, not only after the work is finished.

## JRHs contract
- `DESIGN.md` is the visual direction for JRHs.
- Preserve real JRHs content, assets, URLs, audio, images, and project data unless the user explicitly asks for a content change.
...
- Test responsive behavior, keyboard access, focus states, loading/error states, and reduced-motion behavior.
...
5. Interactive states work: idle, hover/focus, loading, error, open/close where applicable.
6. Reduced motion is respected.
7. No fabricated content was introduced.
8. Existing JRHs content/assets were preserved unless explicitly changed.
