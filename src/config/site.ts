...
export const siteConfig = {
  ...
  about: {
    ...
    titleLine2: 'systems.',
    lead: 'JRH is a personal portfolio for economics, markets, technology, and independent digital work.',
    body: 'My academic foundation is Development Economics at Universitas Islam Indonesia. My interests span macroeconomics, monetary economics, econometrics, capital markets, investing, financial literacy, AI, Web3, and digital products. I work from first principles: understand the problem, structure the evidence, manage risk, then build.',
  },
  facts: [
  ...
  marketProfile: {
    ...
    description: 'Mempelajari pasar melalui risk management, probabilitas, struktur likuiditas, dan transmisi kebijakan moneter dengan prioritas pada survival dan pengendalian downside.',
  },
  projects: [
