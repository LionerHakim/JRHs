    ...
    <section id="hero" className="relative isolate flex min-h-[100svh] items-center overflow-hidden px-5 pt-28 md:px-8 lg:px-12" aria-labelledby="hero-title">
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl items-center gap-12 py-14 md:grid-cols-[1.05fr_.82fr] md:gap-16 lg:py-20">
        ...
        >
          ...
          <h1 id="hero-title" className="max-w-3xl font-serif text-[clamp(3.25rem,9vw,6rem)] font-normal leading-[.92] text-white">JRHs</h1>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a href="#projects" className="portal-pill min-h-11 bg-white px-5 text-sm font-semibold text-black transition active:scale-[.97] hover:bg-[#F7F7F7] focus:outline-none focus-visible:ring-2 focus-visible:ring-white">Jelajahi Proyek</a>
            <a href="#about" className="portal-pill min-h-11 border-[1.5px] border-black/70 bg-transparent px-5 text-sm font-medium text-black transition active:scale-[.97] hover:bg-black/5 focus:outline-none focus-visible:ring-2 focus-visible:ring-white">Tentang JRHs</a>
          </div>
        </motion.div>
        <motion.div
