...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative isolate flex min-h-[100svh] items-center overflow-hidden px-5 pt-28 sm:px-6 md:px-8 lg:px-12" aria-labelledby="hero-title">
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl items-center gap-10 py-12 sm:gap-12 sm:py-14 md:grid-cols-[1.05fr_.82fr] md:gap-16 lg:py-20">
        <motion.div initial={reduceMotion ? false : { opacity: 0, y: 18 }} animate={reduceMotion ? undefined : { opacity: 1, y: 0 }} transition={{ duration: .5 }}>
          ...
          <h1 id="hero-title" className="max-w-3xl font-[var(--font-perfectly-nineties-regular)] text-[clamp(3.25rem,15vw,6rem)] font-normal leading-[.92] text-white">JRHs</h1>
        ...
        <motion.div initial={reduceMotion ? false : { opacity: 0, scale: .97 }} animate={reduceMotion ? undefined : { opacity: 1, scale: 1 }} transition={{ duration: .65, delay: .08 }} className="justify-self-center md:justify-self-end">
          <div className="rounded-[30px] border border-white/60 bg-white/20 p-2 shadow-[0_0_0_5px_rgba(255,255,255,.14)] backdrop-blur-[2px]">
            <div className="h-[min(76vw,20rem)] w-[min(76vw,20rem)] overflow-hidden rounded-[24px] lg:h-[410px] lg:w-[410px]">
