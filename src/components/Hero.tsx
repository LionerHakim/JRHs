      ...
      <div className="relative z-10 mx-auto grid w-full max-w-6xl items-center gap-8 py-10 md:grid-cols-[1fr_.72fr] md:gap-12 lg:py-16">
        ...
        <div className="justify-self-center md:justify-self-end">
          <div className="ios-tile overflow-hidden p-1.5">
            <div className="h-[min(76vw,20rem)] w-[min(76vw,20rem)] overflow-hidden rounded-[5px] sm:h-[21rem] sm:w-[21rem] lg:h-[380px] lg:w-[380px]"><img src={photo} alt="Potret JRHs" className="h-full w-full object-cover" fetchPriority="high" decoding="async" /></div>
          </div>
        </div>
      </div>
    </section>
