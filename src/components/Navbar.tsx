    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="hidden lg:flex items-center gap-4 xl:gap-6 z-50">
            {navLinks.map((link) => (
              <a
                key={link.name}
                href={link.href}
          ...
          <div
            className={`flex items-center gap-4 border-l border-white/10 pl-4 sm:pl-6 ml-2 sm:ml-4 z-50 transition-opacity duration-300 ${
              isOpen
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="lg:hidden fixed inset-0 w-full h-screen bg-black/95 backdrop-blur-3xl z-[60] flex flex-col px-6 pt-24 pb-8 overflow-y-auto"
          >
            <motion.button
              type="button"
              ...
              className="absolute top-8 right-6 text-sm font-semibold text-[#ff2a2a] hover:text-white transition-colors duration-300 focus:outline-none"
            >
              Close
            </motion.button>
            ...
            <div className="mt-6 flex flex-col items-end gap-4">
              {navLinks.map((link, index) => (
                <motion.a
                  ...
                  href={link.href}
                  onClick={() => setIsOpen(false)}
                  className="text-right text-[1.75rem] sm:text-[2rem] font-semibold text-white hover:text-white/80 transition-colors duration-300"
                >
                  {link.name}
                </motion.a>
              ))}
      ...
      >
        ...
        >
          ...
          {/* Right controls: hilang saat mobile menu terbuka */}
          <div
            className={`flex items-center gap-4 border-l border-white/10 pl-4 sm:pl-6 ml-2 sm:ml-4 z-50 transition-opacity duration-300 ${
              isOpen ? 'opacity-0 pointer-events-none lg:opacity-100 lg:pointer-events-auto' : 'opacity-100'
            }`}
          >
            <MusicPlayer />
