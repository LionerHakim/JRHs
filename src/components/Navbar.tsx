...
export default function Navbar() {
  ...
  return (
    <>
      <header className="fixed inset-x-0 top-0 z-50 px-4" style={{ paddingTop: 'max(.75rem, env(safe-area-inset-top))' }}>
        <nav className="mx-auto flex max-w-6xl items-center justify-between gap-3" aria-label="Navigasi utama">
          <a href="#hero" className="flex min-h-11 items-center gap-2 px-1 text-[18px] font-semibold tracking-tight text-[var(--color-ink)]" aria-label="JRHs beranda"><span>JRHs</span><span className="h-1.5 w-1.5 rounded-full bg-[var(--color-accent)]" aria-hidden="true" /></a>
