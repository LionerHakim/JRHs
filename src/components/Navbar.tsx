        ...
        {isOpen && (
          ...
          >
            ...
            <motion.button
              ...
              className="absolute top-28 right-6 text-xs font-semibold text-[#ff2a2a] hover:text-white transition-colors duration-300 focus:outline-none z-50"
            >
              Close
            </motion.button>

            {/* Menu Links */}
            <div className="flex flex-col gap-5 mt-32 items-end">
              {navLinks.map((link, index) => (
                <motion.a
                  ...
                  href={link.href}
                  onClick={() => setIsOpen(false)}
                  className="text-right text-[1.7rem] sm:text-[1.9rem] font-semibold leading-tight text-white hover:text-white/80 transition-colors duration-300"
                >
                  {link.name}
                </motion.a>
              ))}
