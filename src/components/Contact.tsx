      ...
      <div className="mx-auto max-w-7xl border-t border-[var(--color-line)] pt-16 md:pt-20">
        <div className="grid gap-8 md:grid-cols-[.85fr_1.15fr] md:items-end md:gap-20">
          <div>
            ...
            <h2 id="contact-title" className="mt-3 max-w-3xl font-[var(--font-perfectly-nineties-regular)] text-[clamp(2.6rem,7vw,5.5rem)] font-normal leading-[.92] text-[var(--color-ink)]">Keep in touch.</h2>
          </div>
          <div className="max-w-xl">
            <p className="font-[var(--font-inter)] text-base leading-7 text-[var(--color-text)]">Open to meaningful conversations, ideas, and opportunities to build something useful.</p>
