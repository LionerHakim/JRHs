  ...
  return (
    <section id="about" className="section-shell about-section" aria-labelledby="about-title">
      <div className="editorial-grid about-grid">
        <div className="section-intro-sticky"><h2 id="about-title" className="display-title">Tentang saya.</h2><p className="section-index-note">A personal space shaped by curiosity, markets, and building.</p></div>
        <div className="about-reading">
          <p className="about-lead">Berada di persimpangan ekonomi, pasar keuangan, teknologi, dan perilaku manusia.</p>
