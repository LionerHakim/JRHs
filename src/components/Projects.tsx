    ...
    <section id="projects" className="section-shell" aria-labelledby="projects-title">
      ...
      {selected && (
        <div className="fixed inset-0 z-[100]">
          ...
          <aside
            ref={dialogRef}
            className="project-detail-drawer absolute inset-x-0 bottom-0 flex max-h-[92svh] flex-col overflow-y-auto border-t border-[var(--color-line)] bg-[var(--color-control)] p-5 shadow-[var(--shadow-raised)] md:inset-y-0 md:left-auto md:right-0 md:w-[min(32rem,92vw)] md:max-h-none md:border-l md:border-t-0 md:p-7"
            role="dialog"
            aria-modal="true"
          ...
          >
            <div className="flex items-start justify-between gap-4 border-b border-[var(--color-line)] pb-5">
              <div>
                ...
                <h3 id="project-detail-title" className="mt-2 font-[var(--font-perfectly-nineties-regular)] text-4xl font-normal text-[var(--color-ink)]">{selected.title}</h3>
              </div>
              <button
                ref={closeRef}
                type="button"
                onClick={closeProject}
                className="inline-flex min-h-11 min-w-11 items-center justify-center rounded-full border border-[var(--color-line)] bg-[var(--color-paper)] text-[var(--color-ink)] transition hover:border-[var(--color-accent)] hover:text-[var(--color-accent)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent)]"
                aria-label="Tutup detail proyek"
              >
            ...
            <div className="pt-6">
              ...
              <a
                ...
                className="portal-link mt-7 bg-[var(--color-ink)] px-5 font-semibold text-[var(--color-paper)] transition hover:-translate-y-0.5 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent)] active:scale-[.97]"
              >
