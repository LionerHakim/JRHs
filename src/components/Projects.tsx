...
const projects = [
  ...
  { title: 'Pinterest', description: 'Koleksi visual Galuh Purba sebagai referensi inspirasi dan eksplorasi visual.', url: 'https://images.unsplash.com/photo-1547891654-e66ed7ebb968?auto=format&fit=crop&w=1200&h=1500&q=88' },
] as const;
