...
import { ArrowUpRight, BookOpen, BriefcaseBusiness, Code2, ExternalLink, Globe2, Link2, Menu, Moon, Quote, Sparkles, Sun, TrendingUp, Volume2, VolumeX, X } from 'lucide-react'
